...
public class GalleryWidget extends GalleryBase {
  ...
  /** The default spacing between the thumbnail images of the gallery */
   ...
   * @param spacing     the spacing between the thumbnail images
   */
   ...
   * @param spacing     the spacing between the thumbnail images
   */
  public GalleryWidget(Thumbnails thumbnails, String[] captions, int edgeWidth,
      int edgeHeight, int spacing) {
  ...
  public void onResized() {
    ...
    for (int i = 0; i < thumbnails.size(); i++) {
      ...
      row.add(img);
      row.setCellWidth(img, edgeWidth+"px");
    }
