...
galleryCellHTML = u"""<td align="center" valign="middle" width="150" height="150">
  <a href="$LINK">
...
galleryEmptyCellHTML = u"""<td align="center" valign="middle" width="150" height="150">
...
<tr>
  <td>
    <a href="$BACKLINK">
    <img src="icons/back_32.png" alt="back" width="32" height="32" border="0" />
    </a>
  </td>
  <td>
  $GALLERYBUTTON
  ...
  <td>
    <a href="$NEXTLINK">  
    <img src="icons/next_32.png" alt="back" width="32" height="32" border="0" />
    </a>
  </td>
</tr>
</table>
...
<img src="icons/gallery_32.png" alt="back" width="32" height="32" border="0" />
</a>
"""
...
def create_noscript_html(filenames, outputdir, sizes):
    ...
    hasImageLinks = info["image clickable"] == "true"
    def createGallery():
        cells = []
        for i in range(len(filenames)):
            imgName = filenames[i]
            cell = re.sub("\$IMG", "slides/120x120/"+imgName, galleryCellHTML)
...
def create_index_page(outputdir, noscript, offline_page):
    ...
    indexPage = re.sub("\$ALBUM", main_htmlfile, indexPage)
    f = open("index.html", "w")
    try:
        f.write(indexPage)
    finally:
    ...
    for line in inputData:
        if oldJSONBlock:
            ...
            newLine = re.sub("GWTPhotoAlbum/GWTPhotoAlbum.nocache.js", 
                "GWTPhotoAlbum_offline/GWTPhotoAlbum_offline.nocache.js", line)
...
def deploy(pack, dir, modify):
    ...
    try:
        ...
        f.close()
    addJSONtoMainPage(main_htmlfile, modify, 
                      main_htmlfile[:-5]+"_offline.html")
    os.chdir(current_dir)
