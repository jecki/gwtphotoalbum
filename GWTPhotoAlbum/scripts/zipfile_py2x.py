# Notice this file is taken from the python 2.6 distribution and is under 
# the PSF license; please see http://docs.python.org/license.html
#
# I copied the file into this directory so that the scripts also run 
