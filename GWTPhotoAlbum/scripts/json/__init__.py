# Notice the files in this directory are taken from the python 2.6 
# distribution which is under the PSF license; 
# please see http://docs.python.org/license.html
#
# I copied the the json subdirectory from the python 2.6 distribution
# and slightly adjusted the files so that they are compatible with 
# python 2.4 and 2.5 
